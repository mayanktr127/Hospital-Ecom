  ...
  const slides: SlideData[] = [
    {
      ...
      ctaAction: "/sleep-apnea-therapy",
      bgGradient: "from-[#0a1f3c] via-[#1a4079] to-[#0a1f3c]",
      image: "/images/pulmocare/pulmocare_prisma-smart.png",
      bannerImage: "/images/site/designer_banner_cpap_apap.png",
    },
    {
      id: "slide-2",
      badge: "• BILEVEL SLEEP & RESPIRATORY CARE",
      title: "BiLevel Therapy",
      subtitle: "Advanced BiLevel S, ST, AutoST & Titration systems for complex sleep apnea and respiratory insufficiency.",
      ctaText: "Explore BiLevel Series",
      ctaAction: "/bilevel-s-st-devices",
      bgGradient: "from-[#1a4079] via-[#12315c] to-[#0a1f3c]",
      image: "/images/pulmocare/pulmocare_prisma-25-st.png",
      bannerImage: "/images/site/designer_banner_bilevel.png",
    },
    {
      id: "slide-3",
      badge: "• CLINICAL & HOME VENTILATION",
      title: "Ventilation Series",
      subtitle: "High-performance life-support & invasive / non-invasive clinical ventilators for hospital & home care.",
      ctaText: "Explore Ventilation",
      ctaAction: "/ventilation",
      bgGradient: "from-[#0a1f3c] via-[#12315c] to-[#0a1f3c]",
      image: "/images/pulmocare/pulmocare_luisa-ventilator.png",
      bannerImage: "/images/site/designer_banner_ventilation.png",
    },
    {
      id: "slide-4",
      badge: "• OVERNIGHT SLEEP DIAGNOSTICS",
      title: "Sleep Diagnostics",
      subtitle: "Home & hospital polygraphy PSG systems (Level 1, Level 2 & Level 3 diagnostic studies).",
      ctaText: "Explore Diagnostics",
      ctaAction: "/sleep-diagnostics",
      bgGradient: "from-[#12315c] via-[#0a1f3c] to-[#0a1f3c]",
      image: "/images/pulmocare/pulmocare_polygraphy-devices-scala.png",
      bannerImage: "/images/site/designer_banner_elisa.png",
    },
    {
      id: "slide-5",
      badge: "• PATIENT INTERFACE & MASKS",
      title: "LENA & CARA Masks",
      subtitle: "Maximum therapy compliance with ultra-quiet exhalation systems and comfortable silicone seals.",
