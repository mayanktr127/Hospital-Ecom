        ...
        <div className="space-y-8 font-inter text-[#003865]">
          ...
          <div className="bg-white border border-[#003865]/12 rounded-[28px] p-6 md:p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="font-archivo font-bold text-xl text-[#003865]">Data Controller &amp; Contact</h2>
            </div>
            
            <div className="text-xs md:text-sm text-[#4A607A] leading-relaxed space-y-3">
              <p>
                The entity responsible for processing personal data on this website pursuant to Art. 4 No. 7 GDPR is:
              </p>
              <div className="p-4 rounded-2xl bg-[#F0F6FA] border border-[#003865]/08 font-mono text-[#003865]">
          ...
          <div className="bg-white border border-[#003865]/12 rounded-[28px] p-6 md:p-8 shadow-sm space-y-4">
            <h2 className="font-archivo font-bold text-xl text-[#003865]">Principles of Data Processing</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs text-[#4A607A]">
              <div className="p-4 rounded-2xl bg-[#F0F6FA] border border-[#003865]/08">
                <span className="font-bold text-[#003865] block mb-1">Server Log Files (Art. 6(1)(f) GDPR):</span>
              ...
              <div className="p-4 rounded-2xl bg-[#F0F6FA] border border-[#003865]/08">
                <span className="font-bold text-[#003865] block mb-1">Document Request Forms (Art. 6(1)(b) GDPR):</span>
          ...
          <div className="bg-white border border-[#003865]/12 rounded-[28px] p-6 md:p-8 shadow-sm space-y-4">
            <h2 className="font-archivo font-bold text-xl text-[#003865]">Your Rights Under GDPR</h2>
